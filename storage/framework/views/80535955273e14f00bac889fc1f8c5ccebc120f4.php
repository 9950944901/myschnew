          ...
          <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="row">
              <div class="card info-card sales-card">
                <form action="<?php echo e(route('Teacher.teachers-timetable')); ?>" method="get">
                  <?php echo csrf_field(); ?>
                <div class="row p-3">
                  ...
                  <?php if($data_grid==!null): ?>
                    <?php $__currentLoopData = $data_grid; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <div class="text-success mt-1 p-1" style="font-size:13px;background:rgb(205, 227, 236)"><b>
                          Class: <?php echo e($value->class); ?> <a href="#" style="margin-left: 55px;" class="afs"><i class="fa fa-times"></i></a> <br> Section: <?php echo e($value->section); ?> <br> Subject: <?php echo e($value->subject); ?> <br> 
...
<?php echo $__env->make('layouts.teacher', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u640337273/domains/biddersy.com/public_html/school/resources/views/teacher/academics/teachers-timetable.blade.php ENDPATH**/ ?>