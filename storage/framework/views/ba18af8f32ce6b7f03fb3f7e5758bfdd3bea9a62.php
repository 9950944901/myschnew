    ...
    <div class="dashboard">
      <section class="section dashboard">
        <div class="row">
          ...
          <!-- left side columns -->
          <div class="col-lg-4">
            <form action="<?php echo e(route('Add.Topic')); ?>" method="post">
              <?php echo csrf_field(); ?>
            <div class="card">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <tr id="task-2" class="task-list-row test-font" data-task-id="2" data-user="Silver">
                      ...
                      <td>
                        <div class="d-flex">
                          <a href="<?php echo e(route('Topic.Edit',['id'=>$value->id])); ?>" class="btn btn-light ml-1"><i class="fa fa-pencil"></i></a>
                          <a href="<?php echo e(route('Topic.Delete',['id'=>$value->id])); ?>" class="btn btn-light ml-1 delete-confirm"><i class="fa fa-times"></i></a>
                        </div>
                      </td>
                    </tr>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u640337273/domains/biddersy.com/public_html/school/resources/views/school/lesson-plan/topic.blade.php ENDPATH**/ ?>