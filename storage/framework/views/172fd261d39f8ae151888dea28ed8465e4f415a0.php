                  ...
                  <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        <form action="<?php echo e(route('TAdd.Student.Leave')); ?>" method="post" enctype="multipart/form-data">
                          <?php echo csrf_field(); ?>
                        <div class="row">
                ...
                <tbody>
                  ...
                  <tr id="task-2" class="task-list-row test-font" data-task-id="2" data-user="Silver">
                    ...
                    <td>
                      <div class="d-flex">
                        <?php if($value->status==1): ?>
                        <a href="<?php echo e(route('TStudent.Approve.Change.Status',['id'=>$value->id])); ?>" class="btn btn-secondary ml-1"><i class="fa fa-times" onclick="return confirm('Are you sure you want to Approve Leave <?php echo e($value->Student_name); ?>?');"></i></a>
                        <?php else: ?>
...
<?php echo $__env->make('layouts.teacher', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u640337273/domains/biddersy.com/public_html/school/resources/views/teacher/attendance/approve-leave.blade.php ENDPATH**/ ?>