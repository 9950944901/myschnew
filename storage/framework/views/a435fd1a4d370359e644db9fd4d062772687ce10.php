        ...
        <div class="col-xl-4">
          ...
          <div class="card">
            <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
              ...
              <img src="<?php echo e(url('public/uploads/school/'.$user->image)); ?>" style="height: 120px;width:100%;" alt="NO IMAGE" class="rounded-circle">
              <h2><?php echo e($user->name); ?></h2>
              <h3><?php echo e($user->job); ?></h3>
              ...
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8"><?php echo e($user->school_name); ?></div>
                  </div>

                  <div class="row">
                    <div class="col-lg-3 col-md-4 label">Job</div>
                    <div class="col-lg-9 col-md-8"><?php echo e($user->job); ?></div>
                  </div>
                  ...
                  <form method="post" action="<?php echo e(route('ADMIN.Profile.Update')); ?>" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <img src="<?php echo e(url('public/uploads/school/'.$user->image)); ?>" alt="NO IMAGE">
                        <div class="pt-2">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u640337273/domains/biddersy.com/public_html/school/resources/views/school/pages/index.blade.php ENDPATH**/ ?>