          ...
          <div class="col-lg-4">
            <div class="card">
              <div class="card-body" style="padding: 0 20px 0px 20px;">
                ...
                <hr>
                <div class="activity">
                  <form action="<?php echo e(route('Add.Department')); ?>" method="post">
                    <?php echo csrf_field(); ?>
                  <div class="row">
                    ...
                    <tr id="task-1" class="task-list-row test-font" data-task-id="1" data-user="Platinum">
                      ...
                      <td>
                        <div class="d-flex">
                          ...
                          <a href="<?php echo e(route('Department.Delete',['id'=>$value->id])); ?>" class="btn btn-light ml-1 delete-confirm"><i class="fa fa-times"></i></a>
                        </div>
                      </td>
                    </tr>
                      ...
                      <div class="modal-dialog">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            <form method="post" action="<?php echo e(route('Department.Update',['id'=>$value->id])); ?>">
                              <?php echo csrf_field(); ?>
                              <div class="mb-3">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u640337273/domains/biddersy.com/public_html/school/resources/views/school/human-resource/department.blade.php ENDPATH**/ ?>