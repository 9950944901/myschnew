          ...
          <div class="col-lg-4">
            <div class="card">
              <div class="card-body" style="padding: 0 20px 0px 20px;">
                ...
                <hr>
                <div class="activity">
                  <form action="<?php echo e(route('Assign.Class.Teacher.Data')); ?>" method="post">
                    <?php echo csrf_field(); ?>
                  <div class="row">
                    ...
                    <div class="col-lg-12 col-md-6 col-sm-12">
                      <div class="form-group1 text-left mb-2">
                        ...
                        <?php $__currentLoopData = $staff; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $info): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div>
                          <input type="radio" name="class_teacher" value="<?php echo e($info->firstname); ?> <?php echo e($info->lastname); ?>"> <?php echo e($info->firstname); ?> <?php echo e($info->lastname); ?>
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <tr id="task-4" class="task-list-row test-font" data-task-id="2" data-user="Silver">
                     ...
                     <td><?php echo e($value->class_teacher); ?></td>
                      ...
                      <td>
                        <div class="d-flex">
                          ...
                          <a href="<?php echo e(route('Assign .Delete',['id'=>$value->id])); ?>" class="btn btn-light ml-1 delete-confirm"><i class="fa fa-times"></i></a>
                        </div>
                      </td>
                    </tr>
                      ...
                      <div class="modal-dialog">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            <form method="post" action="<?php echo e(route('Update.Class.Teacher',['id'=>$value->id])); ?>">
                              <?php echo csrf_field(); ?>
                              <div class="row">
                                ...
                                <div class="col-lg-12 col-md-6 col-sm-12">
                                  <div class="form-group1 text-left mb-2">
                                    <label for="Name">Class Teacher</label>
                                    <div>
                                      <input type="radio" name="class_teacher" checked value="<?php echo e($value->class_teacher); ?>"><?php echo e($value->class_teacher); ?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u640337273/domains/biddersy.com/public_html/school/resources/views/school/academics/assign-class-teacher.blade.php ENDPATH**/ ?>