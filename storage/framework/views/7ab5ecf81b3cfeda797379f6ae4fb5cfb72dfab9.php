          ...
          <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="row">
              <div class="card info-card sales-card">
                <form action="<?php echo e(route('Teacher.student-attendance')); ?>" method="get">
                  <?php echo csrf_field(); ?>
                <div class="row mb-3">
              ...
              <div class="p-3 d-flex justify-content-between">
                ...
                <a href="<?php echo e(route('TEACHER.Student.Att')); ?>" class="btn btn-info"><i class="fa fa-plus"></i> Attendance</a>
              </div>
...
<?php echo $__env->make('layouts.teacher', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u640337273/domains/biddersy.com/public_html/school/resources/views/teacher/attendance/index.blade.php ENDPATH**/ ?>