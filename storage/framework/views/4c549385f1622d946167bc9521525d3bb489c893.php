          ...
          <div class="row">
            ...
            <div class="col-md-12">
              <div class="filterDiv student p-4">
                ...
                <form action="<?php echo e(route('SCHOOL.student-information')); ?>" method="get">
                  <?php echo csrf_field(); ?>
                <div class="row ">
                    ...
                    <tr id="task-1" class="task-list-row test-font" data-task-id="1" data-user="Platinum">
                      ...
                      <td>
                        <div class="d-flex">
                          ...
                          <a href="<?php echo e(route('SCHOOL.student-details-edit',['id'=>$value->id])); ?>" class="btn btn-light ml-1"><i class="fa fa-edit"></i></a>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u640337273/domains/biddersy.com/public_html/school/resources/views/school/reports/index.blade.php ENDPATH**/ ?>