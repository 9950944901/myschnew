				...
				<div class="col-md-6 col-lg-5">
					<div class="login-box bg-white box-shadow border-radius-10">
						<div class="login-title">
							<h1 class="text-center text-primary animate-charcter">Teacher Login</h1>
						</div>
                        ...
                        <?php endif; ?>
						<form method="post" action="<?php echo e(route('Teacher.Login.Data')); ?>">
							<?php echo csrf_field(); ?>
							...
							<div class="row pb-30">
								...
								<div class="col-6">
									<div class="forgot-password">
										<a href="<?php echo e(route('teacher.forget.pass')); ?>">Forgot Password</a>
									</div>
								</div>
							</div>
							<div class="row">
...
</html><?php /**PATH /home/u640337273/domains/biddersy.com/public_html/school/resources/views/teacher/pages/teacher-login.blade.php ENDPATH**/ ?>