        ...
        <div class="row">
          ...
          <div class="col-lg-8 col-md-6 col-xs-12">
            <form class="contact-form" method="post" action="<?php echo e(route('Site.Contect.Request')); ?>">
              ...
              <input type="text" pattern="['0-9']*" minlength="10" maxlength="10" name="number" placeholder="Your Mobile No." class="contact-input" style="border-bottom: 1px solid;" required>
...
<?php echo $__env->make('site.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u640337273/domains/biddersy.com/public_html/school/resources/views/site/contact.blade.php ENDPATH**/ ?>