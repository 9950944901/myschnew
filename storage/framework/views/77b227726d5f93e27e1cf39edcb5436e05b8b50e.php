          ...
          <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="row">
              <div class="card info-card sales-card">
                <form action="<?php echo e(route('Teacher.exam-schedule')); ?>" method="get">
                  <?php echo csrf_field(); ?>
                <div class="row mb-3">
              ...
              <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <form action="<?php echo e(route('TAdd.Exam.Schedule')); ?>" method="post" enctype="multipart/form-data">
                      <?php echo csrf_field(); ?>
                    <div class="row">
                      <div class="col-lg-6 col-md-6 col-sm-6">
                        <div class="form-group1 text-left">
                          ...
                          <select name="class" class="form-control neha-text" required>
                            <option value="">Select</option>
                            <?php $__currentLoopData = $aa_class; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $aa_classss): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              <option><?php echo e($aa_classss->class); ?></option>
                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                ...
                <tbody>
                  ...
                  <tr id="task-1" class="task-list-row test-font" data-task-id="1" data-user="Platinum">
                    ...
                    <td>
                      <div class="d-flex">
                        ...
                        <a href="<?php echo e(route('TExam.schedule.Delete',['id'=>$value->id])); ?>" class="btn btn-light ml-2 delete-confirm"><i class="fa fa-trash"></i></a>
                      </div>
                    </td>
                  </tr>
                  ...
                  <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        <form action="<?php echo e(route('TUpdate.Exam.Schedule',['id'=>$value->id])); ?>" method="post" enctype="multipart/form-data">
                          <?php echo csrf_field(); ?>
                        <div class="row">
                          <div class="col-lg-6 col-md-6 col-sm-6">
                            <div class="form-group1 text-left">
                          ...
                          <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="form-group1 text-left">
                              <label for="number">Marks (Max.)</label>
                              <input type="number" class="form-control neha-text" name="max_marks" value="<?php echo e($value->max_marks); ?>">
                            </div>
                          </div>
                          <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="form-group1 text-left">
                              <label for="number">Marks (Min.)</label>
                              <input type="number" class="form-control neha-text" name="min_marks" value="<?php echo e($value->min_marks); ?>">
                            </div>
                          </div>
...
<?php echo $__env->make('layouts.teacher', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u640337273/domains/biddersy.com/public_html/school/resources/views/teacher/examinations/exam-schedule.blade.php ENDPATH**/ ?>