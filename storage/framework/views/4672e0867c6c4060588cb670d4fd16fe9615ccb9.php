                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <div class="row">
                            <div class="card info-card sales-card">
                                ...
                                <form action="<?php echo e(route('SCHOOL.Student.result.up',['id'=>$data->id])); ?>" method="post">
                                    <?php echo csrf_field(); ?>
                                    <div class="row">
                                        ...
                                        <div class="col-lg-3 col-md-6 sol-sm-12">
                                            ...
                                            <div class="">
                                                <select name="exam_group" class="form-control neha-text" required>
                                                    <option><?php echo e($data->exam_group); ?></option>
                                        ...
                                        <div class="col-lg-3 col-md-6 sol-sm-12">
                                            ...
                                            <div class="">
                                                <select name="class"  class="form-control neha-text">
                                                    <option><?php echo e($data->class); ?></option>
                                                    <?php $__currentLoopData = $class; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $cls): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                        <option value="<?php echo e($cls->id); ?>"><?php echo e($cls->class); ?></option>
                                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-lg-3 col-md-6 sol-sm-12">
                                            ...
                                            <div class="">
                                                <select name="section" class="form-control neha-text">
                                                    <option><?php echo e($data->section); ?></option>
                                        ...
                                        <div class="col-lg-3 col-md-3 sol-sm-12">
                                            ...
                                            <div class="">
                                                <select name="roll_no" id="" class="form-control neha-text">
                                                    <option><?php echo e($data->roll_no); ?></option> 
                                                    <?php $__currentLoopData = $Stu_Admiss; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $se239): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                    <option><?php echo e($se239->roll_no); ?></option>
                                                <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-lg-3 col-md-6 sol-sm-12">
                                            ...
                                            <div class="">
                                                <select name="add_no" id="" class="form-control neha-text">
                                                    <option><?php echo e($data->add_no); ?></option> 
                                                        ...
                                                        <div class="container">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-3 col-md-6 sol-sm-12">
                                                                    ...
                                                                    <div class="">
                                                                        <input type="text" pattern="['0-9']*" class="form-control neha-text" maxlength="100"   required name="half_english" value="<?php echo e($data->half_english); ?>">
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-3 col-md-6 sol-sm-12">
                                                                    ...
                                                                    <div class="">
                                                                        <input type="text" pattern="['0-9']*"
                                                                            class="form-control neha-text" maxlength="100" name="half_hindi" value="<?php echo e($data->half_hindi); ?>">
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-3 col-md-6 sol-sm-12">
                                                                    ...
                                                                    <div class="">
                                                                        <input type="text" pattern="['0-9']*"
                                                                            class="form-control neha-text" maxlength="100" name="half_math" value="<?php echo e($data->half_math); ?>">
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-3 col-md-6 sol-sm-12">
                                                                    ...
                                                                    <div class="">
                                                                        <input type="text" pattern="['0-9']*"
                                                                            class="form-control neha-text" maxlength="100" name="half_science" value="<?php echo e($data->half_science); ?>">
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-3 col-md-6 sol-sm-12">
                                                                    ...
                                                                    <div class="">
                                                                        <input type="text" pattern="['0-9']*"
                                                                            class="form-control neha-text" maxlength="100" name="half_social" value="<?php echo e($data->half_social); ?>">
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-3 col-md-6 sol-sm-12">
                                                                    ...
                                                                    <div class="">
                                                                        <input type="text" pattern="['0-9']*"
                                                                            class="form-control neha-text" maxlength="100" name="half_sanskrit" value="<?php echo e($data->half_sanskrit); ?>">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        ...
                                                        <div class="container">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-3 col-md-6 sol-sm-12">
                                                                    ...
                                                                    <div class="">
                                                                        <input type="text" pattern="['0-9']*"
                                                                            class="form-control neha-text" maxlength="100" name="anul_english" value="<?php echo e($data->anul_english); ?>">
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-3 col-md-6 sol-sm-12">
                                                                    <h6 class="p-2" style="font-size: 14px;">Hindi</h6>
                                                                    <div class="">
                                                                        <input type="text" pattern="['0-9']*"
                                                                            class="form-control neha-text" maxlength="100" name="anul_hindi" value="<?php echo e($data->anul_hindi); ?>">
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-3 col-md-6 sol-sm-12">
                                                                    <h6 class="p-2" style="font-size: 14px;">
                                                                    ...
                                                                    <div class="">
                                                                        <input type="text" pattern="['0-9']*"
                                                                            class="form-control neha-text" maxlength="100" name="anul_math" value="<?php echo e($data->anul_math); ?>">
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-3 col-md-6 sol-sm-12">
                                                                    <h6 class="p-2" style="font-size: 14px;">Science
                                                                    ...
                                                                    <div class="">
                                                                        <input type="text" pattern="['0-9']*"
                                                                            class="form-control neha-text" maxlength="100" name="anul_science" value="<?php echo e($data->anul_science); ?>">
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-3 col-md-6 sol-sm-12">
                                                                    <h6 class="p-2" style="font-size: 14px;">Social
                                                                    ...
                                                                    <div class="">
                                                                        <input type="text" pattern="['0-9']*"
                                                                            class="form-control neha-text" maxlength="100" name="anul_social" value="<?php echo e($data->anul_social); ?>">
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-3 col-md-6 sol-sm-12">
                                                                    <h6 class="p-2" style="font-size: 14px;">Sanskrit</h6>
                                                                    <div class="">
                                                                        <input type="text" pattern="['0-9']*"
                                                                            class="form-control neha-text" maxlength="100" name="anul_sanskrit" value="<?php echo e($data->anul_sanskrit); ?>">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                          </div>
                                                        ...
                                                        <div class="container">
                                                            ...
                                                            <div class="row">
                                                                <div class="col-lg-3 col-md-6 sol-sm-12">
                                                                    ...
                                                                    <div class="">
                                                                        <input type="text"
                                                                            class="form-control neha-text" name="st_english" value="<?php echo e($data->st_english); ?>">
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-3 col-md-6 sol-sm-12">
                                                                    <h6 class="p-2" style="font-size: 14px;">Hindi</h6>
                                                                    <div class="">
                                                                        <input type="text"
                                                                            class="form-control neha-text" name="st_hindi" value="<?php echo e($data->st_hindi); ?>">
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-3 col-md-6 sol-sm-12">
                                                                    <h6 class="p-2" style="font-size: 14px;">
                                                                    ...
                                                                    <div class="">
                                                                        <input type="text"
                                                                            class="form-control neha-text" name="st_math" value="<?php echo e($data->st_math); ?>">
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-3 col-md-6 sol-sm-12">
                                                                    <h6 class="p-2" style="font-size: 14px;">Science
                                                                    ...
                                                                    <div class="">
                                                                        <input type="text"
                                                                            class="form-control neha-text" name="st_science" value="<?php echo e($data->st_science); ?>">
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-3 col-md-6 sol-sm-12">
                                                                    <h6 class="p-2" style="font-size: 14px;">Social
                                                                    ...
                                                                    <div class="">
                                                                        <input type="text"
                                                                            class="form-control neha-text" name="st_social" value="<?php echo e($data->st_social); ?>">
                                                                    </div>
                                                                </div>
                                                                <div class="col-lg-3 col-md-6 sol-sm-12">
                                                                    <h6 class="p-2" style="font-size: 14px;">Sanskrit</h6>
                                                                    <div class="">
                                                                        <input type="text"
                                                                            class="form-control neha-text" name="st_sanskrit" value="<?php echo e($data->st_sanskrit); ?>">
                                                                    </div>
                                                                </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /home/u640337273/domains/biddersy.com/public_html/school/resources/views/school/examinations/exam_result_edit.blade.php ENDPATH**/ ?>