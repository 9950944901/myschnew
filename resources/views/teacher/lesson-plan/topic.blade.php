    ...
    <div class="dashboard">
      <section class="section dashboard">
        <div class="row">
          ...
          <!-- left side columns -->
          <div class="col-lg-4">
            <form action="{{ route('TAdd.Topic') }}" method="post">
              @csrf
            <div class="card">
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <tr id="task-2" class="task-list-row test-font" data-task-id="2" data-user="Silver">
                      ...
                      <td>
                        <div class="d-flex">
                          <a href="{{ route('TTopic.Edit',['id'=>$value->id]) }}" class="btn btn-light ml-1"><i class="fa fa-pencil"></i></a>
                          <a href="{{ route('TTopic.Delete',['id'=>$value->id]) }}" class="btn btn-light ml-1 delete-confirm"><i class="fa fa-times"></i></a>
                        </div>
                      </td>
                    </tr>
                    @endforeach
