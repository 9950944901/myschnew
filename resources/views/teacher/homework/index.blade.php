          ...
          <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="row">
              <div class="card info-card sales-card">
                  ...
                  <form action="{{ route('Teacher.homework') }}" method="get">
                    @csrf
                <div class="row">
                    ...
                    <div class="modal-dialog modal-lg" role="document">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="{{ route('Teacher.Add.HomeWork') }}" method="post" enctype="multipart/form-data">
                                @csrf
                          <div class="row">
                            @php
                                $user = auth()->user();
                  ...
                  <tbody>
                    ...
                    <tr id="task-1" class="task-list-row test-font" data-task-id="1" data-user="Platinum">
                      ...
                      <td>
                        ...
                        <div class="d-flex">
                          ...
                          <a href="{{ route('Teacher.HomeWork.Delete',['id'=>$list->id]) }}" class="btn btn-light ml-1 delete-confirm"><i class="fa fa-trash"></i></a>
                        </div>
                        @else
                    ...
                    <div class="modal-dialog modal-lg" role="document">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <form action="{{ route('Teacher.Update.HomeWork',['id'=>$list->id]) }}" method="post" enctype="multipart/form-data">
                                @csrf
                          <div class="row">
                            @php
                                $user = auth()->user();
