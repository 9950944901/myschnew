                    ...
                    <tr id="task-1" class="task-list-row test-font" data-task-id="1" data-user="Platinum">
                      ...
                      <td>
                        <div class="d-flex">
                          ...
                          <a href="{{route('TDelete.Class',['id'=>$value->id])}}" class="btn btn-light ml-1 delete-confirm"><i class="fa fa-trash"></i></a>
                        </div>
                      </td>
                    </tr>
                      ...
                      <div class="modal-dialog">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            <form method="post" action="{{ route('Teacher.EDIT.Class',['id'=>$value->id]) }}">
                              @csrf
                              <div class="mb-3">
                                <label for="recipient-name" class="col-form-label">Class:</label>
                                <input type="text" class="form-control" name="class" value="{{ $value->class }}" id="recipient-name" required>
                              </div>
                              {{-- <div class="mb-3">
                    ...
                    <tr id="task-1" class="task-list-row test-font" data-task-id="1" data-user="Platinum">
                      ...
                      <td>
                        <div class="d-flex">
                          ...
                          <a href="{{route('TDelete.Section',['id'=>$value->id])}}" class="btn btn-light ml-1 delete-confirm"><i class="fa fa-trash"></i></a>
                        </div>
                      </td>
                    </tr>
                    <div class="modal fade" id="editsection{{ $value->id }}" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                      <div class="modal-dialog">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            <form method="post" action="{{ route('Teacher.Edit.Section',['id'=>$value->id]) }}">
                              @csrf
                              <div class="mb-3">
    ...
    <div class="modal fade" id="addclass" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form method="post" action="{{ route('Teacher.ADD.Class') }}">
              @csrf
              <div class="mb-3">
                <label for="recipient-name" class="col-form-label">Class:</label>
    ...
    <div class="modal fade" id="addsection" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
      <div class="modal-dialog">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form method="post" action="{{ route('Teacher.ADD.Section') }}">
              @csrf
              <div class="mb-3">
                <label for="recipient-name" class="col-form-label">Section:</label>
