          ...
          <div class="col-lg-12 col-md-12 col-sm-12">
            <div class="row">
              <div class="card info-card sales-card">
                <form action="{{ route('Teacher.teachers-timetable') }}" method="get">
                  @csrf
                <div class="row p-3">
                  ...
                  @if($data_grid==!null)
                    @foreach ($data_grid as $value)
                      <div class="text-success mt-1 p-1" style="font-size:13px;background:rgb(205, 227, 236)"><b>
                          Class: {{ $value->class }} <a href="#" style="margin-left: 55px;" class="afs"><i class="fa fa-times"></i></a> <br> Section: {{ $value->section }} <br> Subject: {{ $value->subject }} <br> 
