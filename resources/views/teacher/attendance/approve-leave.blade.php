                  ...
                  <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        <form action="{{ route('TAdd.Student.Leave') }}" method="post" enctype="multipart/form-data">
                          @csrf
                        <div class="row">
                ...
                <tbody>
                  ...
                  <tr id="task-2" class="task-list-row test-font" data-task-id="2" data-user="Silver">
                    ...
                    <td>
                      <div class="d-flex">
                        @if($value->status==1)
                        <a href="{{ route('TStudent.Approve.Change.Status',['id'=>$value->id]) }}" class="btn btn-secondary ml-1"><i class="fa fa-times" onclick="return confirm('Are you sure you want to Approve Leave {{ $value->Student_name }}?');"></i></a>
                        @else
