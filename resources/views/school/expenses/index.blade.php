          ...
          <div class="col-lg-4">
            <div class="card">
              <div class="card-body" style="padding: 0 20px 0px 20px;">
                ...
                <hr>
                <div class="activity">
                  <form action="{{ route('ADD.Expense.Data') }}" method="post" enctype="multipart/form-data">
                    @csrf
                  <div class="row">
                    ...
                    <tr id="task-1" class="task-list-row test-font" data-task-id="1" data-user="Platinum">
                      ...
                      <td>
                        <div class="d-flex">
                          ...
                          <a href="{{ route('Expense.Data.Delete',['id'=>$value->id]) }}" class="btn btn-light ml-1 delete-confirm"><i class="fa fa-times"></i></a>
                        </div>
                      </td>
                    </tr>
                      ...
                      <div class="modal-dialog">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            <form method="post" action="{{ route('Update.Expense.Data',['id'=>$value->id]) }}" enctype="multipart/form-data">
                              @csrf
                              <div class="mb">
                                <label for="Phone">Expense Head</label>
                                <select name="expense_head" class="form-control neha-text" required>
                                  <option>{{ $value->expense_head }}</option>
                                  @foreach ($data as $aa)
