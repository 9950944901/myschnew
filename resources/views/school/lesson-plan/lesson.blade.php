                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    ...
                    <tr id="task-1" class="task-list-row test-font" data-task-id="1" data-user="Platinum">
                      ...
                      <td>
                        <div class="d-flex">
                          <a href="{{ route('Lesson.Edit',['id'=>$value->id]) }}" class="btn btn-light ml-1"><i class="fa fa-pencil"></i></a>
                          <a href="{{ route('Lesson.Delete',['id'=>$value->id]) }}" class="btn btn-light ml-1 delete-confirm"><i class="fa fa-times"></i></a>
                        </div>
                      </td>
                    </tr>
                    @endforeach
