              ...
              <div class="modal-dialog modal-lg" role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <form action="{{ route('Add.Exam.Schedule') }}" method="post" enctype="multipart/form-data">
                      @csrf
                    <div class="row">
                      <div class="col-lg-6 col-md-6 col-sm-6">
                        <div class="form-group1 text-left">
                          ...
                          <select name="class" class="form-control neha-text" required>
                            <option value="">Select</option>
                            @foreach ($ad_class as $ad_classaa)
                              <option>{{ $ad_classaa->class }}</option>
                            @endforeach
                ...
                <tbody>
                  ...
                  <tr id="task-1" class="task-list-row test-font" data-task-id="1" data-user="Platinum">
                    ...
                    <td>
                      <div class="d-flex">
                        ...
                        <a href="{{ route('Exam.schedule.Delete',['id'=>$value->id]) }}" class="btn btn-light ml-2 delete-confirm"><i class="fa fa-trash"></i></a>
                      </div>
                    </td>
                  </tr>
                  ...
                  <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                      ...
                      <div class="modal-body">
                        <form action="{{ route('Update.Exam.Schedule',['id'=>$value->id]) }}" method="post" enctype="multipart/form-data">
                          @csrf
                        <div class="row">
                          <div class="col-lg-6 col-md-6 col-sm-6">
                            <div class="form-group1 text-left">
                          ...
                          <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="form-group1 text-left">
                              <label for="number">Marks (Max.)</label>
                              <input type="text" pattern="['0-9']*" class="form-control neha-text" name="max_marks" value="{{ $value->max_marks }}">
                            </div>
                          </div>
                          <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="form-group1 text-left">
                              <label for="number">Marks (Min.)</label>
                              <input type="text" pattern="['0-9']*" class="form-control neha-text" name="min_marks" value="{{ $value->min_marks }}">
                            </div>
                          </div>
