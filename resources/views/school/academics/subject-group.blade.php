          ...
          <div class="col-lg-4">
            <div class="card">
              <div class="card-body" style="padding: 0 20px 0px 20px;">
                ...
                <hr>
                <div class="activity">
                  <form action="{{ route('Subject.Group.Data') }}" method="post">
                    @csrf
                  <div class="row">
                    <div class="col-md-12">
                     ...
                     <td>{{ $value->name }}</td>
                      ...
                      <td>
                        <div class="d-flex">
                          ...
                          <a href="{{ route('Subject.Group.Delete',['id'=>$value->id]) }}" class="btn btn-light ml-1 delete-confirm"><i class="fa fa-times"></i></a>
                        </div>
                      </td>
                    </tr>
                      ...
                      <div class="modal-dialog">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            <form method="post" action="{{ route('Update.Subject.Group',['id'=>$value->id]) }}">
                              @csrf
                              <div class="row">
                                <div class="col-md-12">
                                  <div class="form-group1 text-left mb-2">
