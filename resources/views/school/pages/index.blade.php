        ...
        <div class="col-xl-4">
          ...
          <div class="card">
            <div class="card-body profile-card pt-4 d-flex flex-column align-items-center">
              ...
              <img src="{{ url('public/uploads/school/'.$user->image) }}" style="height: 120px;width:100%;" alt="NO IMAGE" class="rounded-circle">
              <h2>{{ $user->name }}</h2>
              <h3>{{ $user->job }}</h3>
              ...
              <div class="tab-content pt-2">
                ...
                <div class="tab-pane fade show active profile-overview" id="profile-overview">
                  ...
                  <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8">{{ $user->add }}</div>
                  </div>
                  ...
                  <form method="post" action="{{ route('ADMIN.Profile.Update') }}" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <img src="{{ url('public/uploads/school/'.$user->image) }}" alt="NO IMAGE">
                        <div class="pt-2">
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="add" type="text" class="form-control" id="Address" value="{{ $user->add }}">
                      </div>
                    </div>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <input name="phone" type="text" oninput="this.value = this.value.replace(/[^0-9.]/g, '').replace(/(\..*)\./g, '$1');" minlength="10" maxlength="10" class="form-control" id="Phone" value="{{ $user->phone }}">
                      </div>
                    </div>
                ...
                <div class="tab-pane fade pt-3" id="profile-change-password">
                  ...
                  <form action="{{route('profile.change.pass')}}" method="post">
                    @csrf
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <span class="text-danger w-100">@error('password') {{$message}} @enderror</span>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <span class="text-danger w-100">@error('new_password') {{$message}} @enderror</span>
                    ...
                    <div class="row mb-3">
                      ...
                      <div class="col-md-8 col-lg-9">
                        <span class="text-danger w-100">@error('re_enter_password') {{$message}} @enderror</span>
