                    ...
                    <div class="modal-dialog modal-lg" role="document">
                      <div class="modal-content">
                        ...
                        <div class="modal-body">
                          <form action="{{ route('Leave.Request.data') }}" method="post" enctype="multipart/form-data">
                            @csrf
                          <div class="row">
              ...
              <table id="example1" class="table table-bordered table-striped">
                ...
                <tbody>
                  ...
                  <tr id="task-1" class="task-list-row test-font" data-task-id="1" data-user="Platinum">
                    ...
                    <td>
                      <div class="d-flex">
                        <a data-bs-toggle="modal" data-bs-target="#editinc{{ $data->id }}" class="btn btn-light ml-1"><i class="fa fa-eye text-info"></i></a>
                        <a href="{{ route('Leave.Request.Delete',['id'=>$data->id]) }}" class="btn btn-light ml-1 delete-confirm"><i class="fa fa-trash text-danger"></i></a>
                        <a href="" data-toggle="modal" data-target="#leaverequestModal12{{ $data->id }}" class="btn btn-light ml-1 "><i class="fa fa-edit text-primary"></i></a>
                      </div>
                    </td>
                  </tr>
                        ...
                        <div class="modal-body">
                          <form method="post" action="{{ route('View.Request.Update',['id'=>$data->id]) }}">
                            ...
                            <div class="mb-3">
                              ...
                              <input type="radio" name="same" {{ ($data->same=="Approved")? "checked" : "" }} value="Approved"> <label>Approved</label> &nbsp;
                              <input type="radio" name="same" {{ ($data->same=="Disapproved")? "checked" : "" }} value="Disapproved"> <label>Disapproved</label>
                            </div>
                  ...
                  <div class="modal fade" id="leaverequestModal12{{ $data->id }}" tabindex="-1" role="dialog"
                  aria-labelledby="exampleModalLabel" aria-hidden="true">
                  <div class="modal-dialog modal-lg" role="document">
                    <div class="modal-content">
                      <div class="modal-header">
                      ...
                      <div class="modal-body">
                        <form action="{{route('leave_request.Up',['id'=>$data->id])}}" method="post" enctype="multipart/form-data">
                          @csrf
                        <div class="row">
                          <div class="col-lg-6 col-md-6 col-sm-6">
                            <div class="form-group1 text-left">
                              <label for="Name">Role</label>
                              <input type="text" name="role" value="{{ $data->role }}" class="form-control neha-text" required>  
                            </div>
                          </div>
                          <div class="col-lg-6 col-md-6 col-sm-6">
                            <div class="form-group1 text-left">
                              <label for="Name">Name</label>
                              <input type="text" value="{{ $data->name }}" class="form-control neha-text" id="Email" name="name" required>  
                            </div>
                          </div>
                          <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="form-group1 text-left">
                              <label for="Email">Apply Date</label>
                              <input type="date" class="form-control neha-text" value="{{ $data->date }}" name="date" required>
                            </div>
                          </div>
                          <div class="col-lg-6 col-md-6 col-sm-6">
                            <div class="form-group1 text-left">
                              <label for="Name">Leave Type</label>
                              <select name="leave_type" class="form-control neha-text"  required>
                                <option>{{ $data->leave_type }}</option>
                                @foreach ($addleavetype as $value1)                                  
                          ...
                          <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="form-group1 text-left">
                              <label for="Email">Leave From Date</label>
                              <input type="date" class="form-control neha-text" value="{{ $data->from_date }}" name="from_date" required>
                            </div>
                          </div>
                          <div class="col-lg-6 col-md-6 col-sm-12">
                            <div class="form-group1 text-left">
                              <label for="Email">Leave To Date</label>
                              <input type="date" class="form-control neha-text" value="{{ $data->todate }}" name="todate" required>
                            </div>
                          </div>
