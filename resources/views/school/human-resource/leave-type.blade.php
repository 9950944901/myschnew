          ...
          <div class="col-lg-4">
            <div class="card">
              <div class="card-body" style="padding: 0 20px 0px 20px;">
                ...
                <hr>
                <div class="activity">
                  <form action="{{ route('Add.Leave.Type') }}" method="post">
                    @csrf
                  <div class="row">
                    ...
                    <tr id="task-1" class="task-list-row test-font" data-task-id="1" data-user="Platinum">
                      ...
                      <td>
                        <div class="d-flex">
                          ...
                          <a href="{{ route('Leave.Type.Delete',['id'=>$value->id]) }}" class="btn btn-light ml-1 delete-confirm"><i class="fa fa-times"></i></a>
                        </div>
                      </td>
                    </tr>
                      ...
                      <div class="modal-dialog">
                        <div class="modal-content">
                          ...
                          <div class="modal-body">
                            <form method="post" action="{{ route('Add.Leave.Type.Update',['id'=>$value->id]) }}">
                              @csrf
                              <div class="mb-3">
