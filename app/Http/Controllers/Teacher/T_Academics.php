...
class T_Academics extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('teacher.academics.index',compact('class','sec','subj','group','data_grid'));
    }
    ...
    public function teachers_timetable(Request $request)
    {
        ...
        return view('teacher.academics.teachers-timetable',compact('staff','class','sec','subj','data_grid'));
    }
    ...
    public function assign_class_teacher()
    {
        ...
        return view('teacher.academics.assign-class-teacher',compact('class','sec','staff','data'));
    }
    ...
    public function promote_students(Request $request)
    {
        ...
        return view('teacher.academics.promote-students',compact('class','sec','show'));
    }
    ...
    public function subject_group()
    {
        ...
        return view('teacher.academics.subject-group',compact('class','sec','sub','data'));
    }

    public function subjects()
    {
        $show = AddSubject::orderBY('id','desc')->get();
        return view('teacher.academics.subjects',compact('show'));
    }

    public function class()
    {
        return view('teacher.academics.class');
    }

    public function sections()
    {
        return view('teacher.academics.sections');
    }
