...
class T_DownloadCenter extends Controller
{
    public function index()
    {
        ...
        return view('teacher.download-center.index',compact('class','sec','content'));
    }

    public function assignments()
    {
        return view('teacher.download-center.assignments');
    }

    public function study_material()
    {
        $content = UploadContent::orderBy('id','desc')->get();
        return view('teacher.download-center.study-material',compact('content'));
    }
    ...
    public function syllabus()
    {
        ...
        return view('teacher.download-center.syllabus',compact('class','subject','data'));
    }

    public function other_downloads()
    {
        return view('teacher.download-center.other-downloads');
    }
