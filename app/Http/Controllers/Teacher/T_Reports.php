...
class T_Reports extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('teacher.reports.index',compact('class','sec','show','data_show','data_grid','data_enqiry'));
    }

    public function finance()
    {
        return view('teacher.reports.finance');
    }
    ...
    public function examinations(Request $request)
    {
        ...
        if($request['session'] && $request['exam_group'] && $request['class'] && $request['section'])
        {
            $data= DB::table('exam_results')
                ...
                ->orderBy('exam_results.id','desc')->where('exam_results.class',$request['class'])
                ->where('exam_results.section',$request['section'])->where('exam_results.exam_group',$request['exam_group'])
                ->where('exam_results.session',$request['session'])
                ->get();
        ...
        return view('teacher.reports.examinations',compact('class','sec','exam_group','data'));
    }

    public function online_examination()
    {
        return view('teacher.reports.online-examination');
    }
    ...
    public function lesson_plan()
    {
        ...
        return view('teacher.reports.lesson-plan',compact('view','syllabus'));
    }

    public function human_resource()
    {
        $show = AddStaff::orderBy('id','desc')->get();
        return view('teacher.reports.human-resource',compact('show'));
    }

    public function transport()
    {
        return view('teacher.reports.transport');
    }

    public function alumni()
    {
        return view('teacher.reports.alumni');
    }
    ...
    public function user_log()
    {
        ...
        return view('teacher.reports.user-log',compact('add_user','staff','student'));
    }
}
